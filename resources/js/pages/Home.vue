...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleGithub() {
                Alert({
                    content: "https://github.com/codercwm"
                });
            },
            handleTips() {
                Alert({
                    ...
                    html:
                        '<div>' +
                        '<img style="width: 200px;" src="https://t8.baidu.com/it/u=1484500186,1503043093&fm=79&app=86&size=h300&n=0&g=4n&f=jpeg?sec=1591173370&t=d48ec6e676ceeea6adbd98ca95c01d40" />' +
                        '</div>'
                });
            }
        },
